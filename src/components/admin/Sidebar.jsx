...
const Sidebar = () => {
  ...
  return (
    <div  className="fixed h-screen left-0 top-0 bg-[#EDF0F1] w-[90px] flex flex-col gap-5 items-center">
      ...
      <div onClick={() => router.push("/admin")}className="cursor-pointer text-[40px] w-full  hover:left-6  hover:w-[160px] text-white bg-[#3C4A5B] gap-4 flex justify-center items-center rounded-r-[20px] py-2 relative z-20">
        <BiHomeAlt />
      ...
      <div onClick={() => router.push("/admin/tienda")} className="cursor-pointer text-[40px] w-full hover:left-6 hover:w-[160px] text-[#3C4A5B] hover:text-white hover:bg-[#3C4A5B] gap-4 flex justify-center items-center rounded-r-[20px] py-2 relative z-20">
        <BiStore className=" " />
