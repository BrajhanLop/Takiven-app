...
const Register = ({ toggle }) => {
  ...
  return (
    <div className=" max-w-[340px] sm:max-w-[450px] md:max-w-[500px] lg:max-w-max lg:w-1/2 bg-[#f2f6fb] md:bg-white flex flex-col md:px-10 md:pt-16 pb-10   md:rounded-[57px]">
      <div>
        <h2 className="text-[30px] font-[700] text-title">Unete a Takiven</h2>
      ...
      <form onSubmit={handleSubmit(submit)} className="flex flex-col gap-2 md:gap-4">
        <div className="flex flex-col">
          <label htmlFor="" className="text-[24px] md:text-[24px] md:font-[500] text-title">
            Correo electronico
          </label>
          <input
        ...
        <div className="flex flex-col">
          <label htmlFor="" className="text-[24px] md:font-[500] text-title">
            Contraseña
          </label>
          <input
            type="password"
        ...
        <p className=" text-[20px] leading-6 xl:pb-3">
          La apertura de una cuenta Takiven está sujeta al estado, condiciones, controles de
          identidad y a personas mayores de 18 años.
        </p>
