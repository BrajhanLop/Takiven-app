...
const MenuCategories = ({ catRef }) => {
  return (
    <div
      ref={catRef}
      className="fixed top-[95px] md:top-[80px] pb-3 bg-[#30F27B] lg:h-[133px] w-[96%] md:w-[60%] lg:w-[62%] xl:w-[60%]  flex gap-y-2 justify-center flex-wrap lg:items-center md:gap-2 xl:items-start  lg:gap-2 xl:gap-8 rounded rounded-b-[20px] pt-3"
    >
