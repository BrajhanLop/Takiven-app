        ...
        <div className="w-[866px] bg-white rounded-[20px] px-5 py-4">
          ...
          <table className="w-full bg-white mb-3 ">
            <thead>
              <tr className=" border-dashed border-b-[1px] border-[#29E197]">
                ...
                <th className="px-6 py-3 text-left border-dashed border-r-[1px] border-[#29E197]">Precio</th>
                <th className="px-6 py-3 text-left border-dashed border-r-[1px] border-[#29E197]">Unidades</th>
            ...
            <tbody>
              {data.map((item, index) => (
                <tr key={item.id}>
                  ...
                  <td className="px-6 py-4 border-dashed border-r-[1px] border-[#29E197]">{item.categoria}</td>
                  <td className="px-6 py-4 border-dashed border-r-[1px] border-[#29E197]">{item.sku}</td>
          ...
          <div className=" flex justify-end mr-5">
            <div>
              ...
              <div className="flex gap-2">
                <p className="text-[18] font-[400] w-[90px]">Comisión: </p> <span>-S/. 266.00</span>
              </div>
              <div className="flex gap-2">
                <p className="text-[18] font-[500] w-[90px]">Total: </p>{" "}
                <span className="text-[18] font-[500]">S/.1994.00</span>
              </div>
            </div>
          </div>
        </div>
        <div className="flex flex-col gap-2 ">
          ...
          <div className="bg-white w-[437px]  rounded-[20px] px-5 py-3">
            ...
            <p className="border-dashed border-b-[1px] border-[#29E197] w-[80%] mx-auto mt-4"></p>
              <p className="text-[14px] font-[300] text-[#6D6D6D] text-center">Para mayor informacion con tus pagos, escribenos:</p>
